...
app.post('/api/measurements/:scale_id', (req, res) => {
    ...
    let sql = `SELECT measurement_id, scale_id, grid_name, operator_name, measurement_time, measurement_date, weight, density, mixer, byrkalo, penetration, status FROM Measurements WHERE scale_id = ?, grid_name = ?, operator name = ?, measurement_date BETWEEN ? AND ?`;
