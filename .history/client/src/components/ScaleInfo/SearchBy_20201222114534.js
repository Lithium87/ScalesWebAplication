...
class SearchBy extends Component {
  ...
  filterResults = (event) => {
    ...
    let selectMaterial = document.getElementById("select_material").value;
    let selectOperator = document.getElementById("select_operator").value;
    const isMaterialChecked = document.getElementById("material_check").value;
    const isOperatorChecked = document.getElementById("operator_check").value;

    if (isMaterialChecked && selectMaterial === "--Изберете материал--") {
      selectMaterial = "";
    }

    if (isOperatorChecked && selectOperator === "--Изберете оператор--") {
      selectOperator = "";
    }
        ...
        <div>
          <Space direction="horizontal">
            ...
            <label>
              ...
              >
                <option>--Изберете оператор--</option>
                {operators
                  ? operators.map((o) => (
